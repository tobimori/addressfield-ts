...
// RETURN TYPE: Recursive parameter unwrapping needs a stable nullable annotation contract.
...
function parameterName(parameter: Parameter, sourceCode: SourceCode) {
...
export const noObjectParametersRule = defineRule({
  ...
  createOnce(context) {
    ...
    // RETURN TYPE: This recursive alias resolver needs a stable boolean contract.
